...
def get_parser():
    ...
    p6.add_argument('--sample_phased', type=str, default='OMNI_Pan-Asian.bgl.phased', help='sample phased file')
    ...
    p12.add_argument('--output', type=str, default='1958BC_European_SNP2HLA', help='output file prefix')
    ...
    p13.add_argument('--output', type=str, default='1958BC_European_HIBAG', help='output file prefix')
    p13.add_argument('--Renv', type=str, default='R4.5', help='conda R environment name where HIBAG is installed')
...
def main():
    ...
    if args.command == 'preprocess':
        ...
        dp = DataPreprocessor(sample_phased=args.sample_phased)
        dp.prepare_to_predict(features_file=args.features_file, out_file=args.output)
